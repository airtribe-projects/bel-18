...
//   .withSpot(spot)
//   .withFloorId(floor.getFloorId())
//   .withEntryTime(entryTime)         // earlier stored entry time
//   .withExitTime(new Date())         // exit time filled now
//   .withAmount(150)                  // parking fee calculated by strategy
//   .paid()                           // mark ticket as paid
//   .build();
